...
import com.glf.pizzashop.repository.PizzaOrderRepository;
...
privileged aspect PizzaOrderDataOnDemand_Roo_DataOnDemand {
    ...
    public PizzaOrder PizzaOrderDataOnDemand.getSpecificPizzaOrder(int index) {
        ...
        com.glf.pizzashop.domain.PizzaOrderPk id = obj.getId();
    ...
    public void PizzaOrderDataOnDemand.init() {
        ...
        data = new ArrayList<com.glf.pizzashop.domain.PizzaOrder>();
        for (int i = 0; i < 10; i++) {
